...
export const commands = {
  ...
  async changeClipboardEnabledSetting(
    enabled: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_clipboard_enabled_setting", {
          enabled,
        }),
      };
    } catch (e) {
  ...
  async changeClipboardMaxRecordsSetting(
    maxRecords: number,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_clipboard_max_records_setting", {
          maxRecords,
        }),
      };
    } catch (e) {
  ...
  async changeClipboardHotkeyEnabledSetting(
    enabled: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_clipboard_hotkey_enabled_setting", {
          enabled,
        }),
      };
    } catch (e) {
  ...
  async changeClipboardHotkeySetting(
    hotkey: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_clipboard_hotkey_setting", { hotkey }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getAvailableCustomWordsModels(): Promise<
    Result<CustomWordsModelInfo[], string>
  > {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_available_custom_words_models"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getCurrentCustomWordsModel(): Promise<Result<string, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_current_custom_words_model"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async setActiveCustomWordsModel(
    modelId: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("set_active_custom_words_model", { modelId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async hasMicrophoneInputAccess(): Promise<Result<boolean, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("has_microphone_input_access"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  ): Promise<Result<ClipboardPageResult, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_clipboard_items", {
          page,
          pageSize,
          sort,
          contentType,
  ...
  async getFavoriteClipboardItems(
    page: number,
    pageSize: number,
    contentType: string,
    sort: string,
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_favorite_clipboard_items", {
          page,
          pageSize,
          contentType,
          sort,
  ...
  async searchClipboard(
    query: string,
    contentType: string,
  ): Promise<Result<ClipboardItem[], string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("search_clipboard", { query, contentType }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async toggleClipboardFavorite(id: number): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("toggle_clipboard_favorite", { id }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async toggleClipboardPin(id: number): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("toggle_clipboard_pin", { id }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async updateClipboardTitle(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("update_clipboard_title", { id, title }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async deleteClipboardItem(id: number): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("delete_clipboard_item", { id }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async clearClipboardHistory(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("clear_clipboard_history", { keepPinned }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async copyClipboardToSystem(id: number): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("copy_clipboard_to_system", { id }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async copyClipboardContentToSystem(
    contentType: string,
    text: string | null,
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("copy_clipboard_content_to_system", {
          contentType,
          text,
          imagePath,
        }),
  ...
  async setClipboardOverlayPinned(
    pinned: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("set_clipboard_overlay_pinned", { pinned }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getClipboardSettings(): Promise<Result<ClipboardSettings, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_clipboard_settings"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async updateClipboardSettings(
    maxRecords: number | null,
    hotkey: string | null,
    confirmMode: string | null,
  ): Promise<Result<ClipboardSettings, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("update_clipboard_settings", {
          maxRecords,
          hotkey,
          confirmMode,
        }),
  ...
  async toggleClipboardMonitoring(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("toggle_clipboard_monitoring", { enabled }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
...
export type AppSettings = {
  ...
  log_level?: LogLevel;
  custom_words?: string[];
  selected_custom_words_model?: string;
  ...
  clipboard_hotkey_enabled?: boolean;
...
export type CustomWordsModelInfo = {
  id: string;
  name: string;
  path: string;
  size_bytes: number;
