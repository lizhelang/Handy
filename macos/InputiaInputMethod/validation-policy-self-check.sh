...
candidate_panel_self_check = read("Tools/InputiaCandidatePanelLayoutSelfCheck.swift")
...
require('"$ROOT_DIR/build/inputia-candidate-panel-layout-self-check"' in dev_fast, "dev-fast-missing-candidate-panel-layout-self-check")
...
require('InputiaCandidateContentView' in candidate_panel, "candidate-panel-missing-content-view")
require('collapsedCandidateLimit = 9' in candidate_panel, "candidate-panel-missing-nine-candidate-cap")
require('expandedCandidateLimit = 40' in candidate_panel, "candidate-panel-missing-expanded-candidate-cap")
require('candidateView.configure' in candidate_panel, "candidate-panel-show-not-using-content-view")
require('InputiaCandidatePanelLayoutSelfCheck.swift' in build, "build-missing-candidate-panel-layout-self-check-tool")
require('inputia-candidate-panel-layout-self-check' in build, "build-missing-candidate-panel-layout-self-check-output")
...
require('candidatePanelLayoutSelfCheckPassed=' in candidate_panel_self_check, "candidate-panel-layout-self-check-missing-pass-marker")
require('widePanelKeepsAllEightCandidates' in candidate_panel_self_check, "candidate-panel-layout-self-check-missing-eight-candidate-case")
require('candidateFramesDoNotOverlap' in candidate_panel_self_check, "candidate-panel-layout-self-check-missing-overlap-case")
require('candidateTextSupportKeepsSupportedNonBMPHan' in candidate_panel_self_check, "candidate-panel-layout-self-check-missing-rare-character-case")
