...
open_settings = read("open-settings.sh")
open_installer = read("open-installer.sh")
build = read("build.sh")
...
require('INPUTIA_OPEN_SETTINGS_PREFLIGHT_SELF_CHECK=1 "$ROOT_DIR/open-settings.sh"' in dev_fast, "dev-fast-missing-open-settings-preflight-self-check")
require('INPUTIA_OPEN_SETTINGS_RESOLUTION_SELF_CHECK=1 "$ROOT_DIR/open-settings.sh"' in dev_fast, "dev-fast-missing-open-settings-resolution-self-check")
require('INPUTIA_OPEN_INSTALLER_PREFLIGHT_SELF_CHECK=1 "$ROOT_DIR/open-installer.sh"' in dev_fast, "dev-fast-missing-open-installer-preflight-self-check")
require('INPUTIA_OPEN_INSTALLER_DRY_RUN_SELF_CHECK=1 "$ROOT_DIR/open-installer.sh"' in dev_fast, "dev-fast-missing-open-installer-dry-run-self-check")
...
require('segmentedPhraseFirstCandidate=' in host_main, "host-diagnostics-missing-segmented-phrase-first-candidate")
require('segmentedSingleSelectionComposing=' in host_main, "host-diagnostics-missing-segmented-single-selection-composing")
...
require('IMKCandidates open the system single-column panel over our grid' in host_main, "host-main-missing-imk-candidates-suppression-comment")
require('override func candidates(_ sender: Any!) -> [Any]! {\n    // Inputia draws its own candidate panel.' in host_main, "host-main-candidates-delegate-not-owned-by-inputia-panel")
require('return []\n  }\n\n  override func menu()' in host_main, "host-main-still-exposes-system-candidates")
...
require('--example rime_probe -- --select-matrix' in dev_fast, "dev-fast-rime-select-probe-not-matrix")
require('double_pinyin:nillem:2:你:-:你laiem:来:来' in dev_fast, "dev-fast-missing-natural-partial-select-probe")
require('double_pinyin_sogou:nillem:2:你:-:你laiem:来:来' in dev_fast, "dev-fast-missing-sogou-partial-select-probe")
require('probeMatrixSelfCheck=true' in rime_probe_example, "rime-probe-missing-matrix-pass-marker")
require('selectProbeMatrixSelfCheck=true' in rime_probe_example, "rime-probe-missing-select-matrix-pass-marker")
...
require('selectedCommitMatches=' in rime_probe_example, "rime-probe-missing-select-commit-assertion")
require('selectedPreeditMatches=' in rime_probe_example, "rime-probe-missing-select-preedit-assertion")
require('expectedNextPresentFound=' in rime_probe_example, "rime-probe-missing-select-next-candidate-assertion")
...
require('^tis.targetInstalledSourceCount=' in install_check, "install-check-missing-target-installed-source-count-output")
require('^tis.targetInstalledUniqueFingerprintCount=' in install_check, "install-check-missing-target-installed-fingerprint-output")
...
require('INPUTIA_APPLY_AFTER_INSTALL_CHECK_FOR_TEST' in apply_current_handoff, "apply-current-handoff-missing-after-install-test-injection")
...
require('INPUTIA_APPLY_ADMIN_INSTALL_FOR_TEST' in apply_current_handoff, "apply-current-handoff-missing-admin-success-test-injection")
require('INPUTIA_ADMIN_PROMPT_MODE' in apply_current_handoff, "apply-current-handoff-missing-admin-prompt-mode")
require('INPUTIA_ADMIN_PROMPT_TIMEOUT_SECONDS' in apply_current_handoff, "apply-current-handoff-missing-admin-prompt-timeout")
require('INPUTIA_APPLY_ADMIN_OSASCRIPT_FOR_TEST' in apply_current_handoff, "apply-current-handoff-missing-osascript-admin-test-injection")
require('INPUTIA_APPLY_ADMIN_OSASCRIPT_TIMEOUT_FOR_TEST' in apply_current_handoff, "apply-current-handoff-missing-osascript-timeout-test-injection")
require('INPUTIA_APPLY_REPAIR_TIS_FOR_TEST' in apply_current_handoff, "apply-current-handoff-missing-repair-success-test-injection")
require('INPUTIA_APPLY_AWAIT_INSTALL_FOR_TEST' in apply_current_handoff, "apply-current-handoff-missing-await-success-test-injection")
...
require('applyCurrentHandoffAdminPromptMode=osascript' in apply_current_handoff, "apply-current-handoff-missing-osascript-admin-mode-marker")
require('applyCurrentHandoffAdminPromptTimeoutSeconds=' in apply_current_handoff, "apply-current-handoff-missing-osascript-timeout-marker")
require('applyCurrentHandoffAdminInstallForTest=osascript' in apply_current_handoff, "apply-current-handoff-missing-osascript-admin-success-marker")
require('applyCurrentHandoffAdminPromptTimedOut=true' in apply_current_handoff, "apply-current-handoff-missing-osascript-timeout-output")
require('applyCurrentHandoffPassed=false reason=admin-authorization-timeout' in apply_current_handoff, "apply-current-handoff-missing-authorization-timeout-reason")
require('do shell script (item 1 of argv) with administrator privileges' in apply_current_handoff, "apply-current-handoff-missing-osascript-admin-authorization")
require('ps -p "$osascript_pid" -o stat=' in apply_current_handoff, "apply-current-handoff-missing-osascript-zombie-check")
require('applyCurrentHandoffAdminInstallForTest=true' in apply_current_handoff, "apply-current-handoff-missing-admin-success-marker")
require('applyCurrentHandoffRepairTISForTest=true' in apply_current_handoff, "apply-current-handoff-missing-repair-success-marker")
require('applyCurrentHandoffAwaitForTest=true' in apply_current_handoff, "apply-current-handoff-missing-await-success-marker")
require('success-chain-order-mismatch' in apply_current_handoff, "apply-current-handoff-missing-success-order-assertion")
require('applyCurrentHandoffPassed=false reason=admin-install-did-not-update-system' in apply_current_handoff, "apply-current-handoff-missing-admin-still-required-marker")
require('repair-ran-after-admin-still-required' in apply_current_handoff, "apply-current-handoff-missing-no-repair-after-admin-still-required-assertion")
...
require('maximumCollapsedCandidateCount = 9' in candidate_panel, "candidate-panel-missing-collapsed-nine-candidate-cap")
require('maximumExpandedRows = 4' in candidate_panel, "candidate-panel-missing-expanded-four-row-cap")
require('InputiaCandidatePanelModel' in candidate_panel, "candidate-panel-missing-structured-model")
require('InputiaCandidatePanelContentView' in candidate_panel, "candidate-panel-missing-custom-content-view")
require('topSuggestions' in candidate_panel, "candidate-panel-missing-top-suggestions")
require('mainCandidates' in candidate_panel, "candidate-panel-missing-main-candidates")
require('charCandidates' in candidate_panel, "candidate-panel-missing-char-candidates")
require('rareCandidates' in candidate_panel, "candidate-panel-missing-rare-candidates")
require('usesStructuredGrid = true' in candidate_panel, "candidate-panel-missing-structured-grid-marker")
require('wrapsCandidateText = false' in candidate_panel, "candidate-panel-missing-no-wrap-marker")
require('lineBreakMode = .byTruncatingTail' in candidate_panel, "candidate-panel-missing-truncating-tail")
require('mainCandidateOriginalIndex(forLabel' in candidate_panel, "candidate-panel-missing-main-label-index-map")
require('InputiaCandidatePanelFormatter.model' in candidate_panel, "candidate-panel-show-not-using-structured-model")
require('handleMainCandidateDigit' in host_main, "host-main-missing-structured-digit-selection")
require('pageSize: latestCandidatePageSize' in host_main, "host-main-candidate-panel-not-using-page-size")
require('activePage: bridge.latestOutcome.page' in host_main, "host-main-candidate-panel-not-using-active-page")
...
require('INPUTIA_OPEN_SETTINGS_PREFLIGHT_SELF_CHECK' in open_settings, "open-settings-missing-preflight-self-check")
require('INPUTIA_OPEN_SETTINGS_RESOLUTION_SELF_CHECK' in open_settings, "open-settings-missing-resolution-self-check")
require('INPUTIA_OPEN_SETTINGS_DRY_RUN' in open_settings, "open-settings-missing-dry-run")
require('InputiaExpectedHostCDHash' in open_settings, "open-settings-missing-expected-host-cdhash-check")
require('skippedStaleSettingsLauncher=' in open_settings, "open-settings-missing-stale-launcher-output")
require('skippedStaleSettingsHost=' in open_settings, "open-settings-missing-stale-host-output")
require('openSettingsResolutionSelfCheck=true' in open_settings, "open-settings-missing-resolution-self-check-success")
require('stale-system-launcher-not-skipped' in open_settings, "open-settings-missing-stale-launcher-assertion")
require('stale-host-not-skipped' in open_settings, "open-settings-missing-stale-host-assertion")
require('INPUTIA_OPEN_INSTALLER_PREFLIGHT_SELF_CHECK' in open_installer, "open-installer-missing-preflight-self-check")
require('INPUTIA_OPEN_INSTALLER_DRY_RUN_SELF_CHECK' in open_installer, "open-installer-missing-dry-run-self-check")
require('INPUTIA_OPEN_INSTALLER_PACKAGE_FOR_TEST' in open_installer, "open-installer-missing-package-test-injection")
require('INPUTIA_OPEN_INSTALLER_DRY_RUN' in open_installer, "open-installer-missing-dry-run-open")
require('openInstallerDryRunSelfCheck=true' in open_installer, "open-installer-missing-dry-run-self-check-success")
require('openInstallerDryRun=true path=' in open_installer, "open-installer-missing-dry-run-output")
require('build_or_test_pkg_path' in open_installer, "open-installer-missing-build-or-test-helper")
...
require('candidatePanelUsesStructuredGrid' in candidate_panel_self_check, "candidate-panel-self-check-missing-structured-grid-case")
require('candidatePanelTopSuggestionsArePhrases' in candidate_panel_self_check, "candidate-panel-self-check-missing-top-suggestion-case")
require('candidatePanelMainCandidatesHaveLocalLabels' in candidate_panel_self_check, "candidate-panel-self-check-missing-main-local-label-case")
require('candidatePanelSingleCharactersMoveToGrid' in candidate_panel_self_check, "candidate-panel-self-check-missing-char-grid-case")
require('candidatePanelRareCandidatesAreSeparated' in candidate_panel_self_check, "candidate-panel-self-check-missing-rare-section-case")
require('candidatePanelHeightStableForTextLength' in candidate_panel_self_check, "candidate-panel-self-check-missing-stable-height-case")
...
require('INPUTIA_FULL_CHECK_SELF_CHECK' in full_check, "full-check-missing-self-check-mode")
require('INPUTIA_FULL_CHECK_INSTALL_CHECK_OUTPUT_FOR_TEST' in full_check, "full-check-missing-install-check-test-injection")
require('INPUTIA_FULL_CHECK_NOTARIZATION_OUTPUT_FOR_TEST' in full_check, "full-check-missing-notarization-test-injection")
require('INPUTIA_FULL_CHECK_MENU_READINESS_FOR_TEST' in full_check, "full-check-missing-menu-readiness-test-mode")
require('INPUTIA_FULL_CHECK_POST_INSTALL_FOR_TEST' in full_check, "full-check-missing-post-install-test-mode")
require('fullCheckSelfCheck=true' in full_check, "full-check-missing-self-check-pass-marker")
require('run_self_check_case install-gate' in full_check, "full-check-missing-install-gate-self-check")
require('run_self_check_case notary-gate' in full_check, "full-check-missing-notary-gate-self-check")
require('fullCheckHeavyOptInEnabled=true' in full_check, "full-check-missing-heavy-opt-in-marker")
require('install-gate-enabled-heavy-checks' in full_check, "full-check-missing-install-gate-heavy-negative-assertion")
require('notary-gate-enabled-heavy-checks' in full_check, "full-check-missing-notary-gate-heavy-negative-assertion")
require('success-menu-opt-in-not-set' in full_check, "full-check-missing-success-menu-opt-in-assertion")
require('success-ui-smoke-not-set' in full_check, "full-check-missing-success-ui-smoke-assertion")
require('"$ROOT_DIR/install-check.sh"' in full_check, "full-check-missing-install-check-gate")
require('installCheckPassed=true' in full_check, "full-check-missing-install-check-pass-gate")
require('releaseFullCheckPassed=false reason=install-check-not-ready' in full_check, "full-check-missing-install-check-failure")
...
require(full_check.index('"$ROOT_DIR/verify-pkg.sh"') < full_check.index('"$ROOT_DIR/install-check.sh"'), "full-check-install-check-before-pkg-verified")
require(full_check.index('"$ROOT_DIR/install-check.sh"') < full_check.index('"$ROOT_DIR/notarization-readiness.sh"'), "full-check-notarization-before-install-ready")
require(full_check.index('"$ROOT_DIR/install-check.sh"') < full_check.index('INPUTIA_MENU_READINESS_ALLOW_AXPRESS=1'), "full-check-menu-opt-in-before-install-ready")
require(full_check.index('"$ROOT_DIR/install-check.sh"') < full_check.index('INPUTIA_GUI_SMOKE_READINESS_ALLOW_CHECK=1'), "full-check-gui-opt-in-before-install-ready")
require(full_check.index('"$ROOT_DIR/notarization-readiness.sh"') < full_check.index('INPUTIA_MENU_READINESS_ALLOW_AXPRESS=1'), "full-check-menu-opt-in-before-notary-ready")
require(full_check.index('"$ROOT_DIR/notarization-readiness.sh"') < full_check.index('INPUTIA_RUN_UI_SMOKE=1'), "full-check-ui-smoke-opt-in-before-notary-ready")
...
require(full_check.index('"$ROOT_DIR/install-check.sh"') < full_check.index('"$ROOT_DIR/menu-readiness.sh"'), "full-check-menu-readiness-before-install-ready")
require(full_check.index('"$ROOT_DIR/install-check.sh"') < full_check.index('"$ROOT_DIR/post-install-regression.sh" "$APP"'), "full-check-postinstall-before-install-ready")
