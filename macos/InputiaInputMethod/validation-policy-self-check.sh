...
require('safePageSize * maximumExpandedRows' in candidate_panel, "candidate-panel-expanded-cap-not-page-size-based")
require('columnIndex == 0 ? "\\n" : "\\t"' in candidate_panel, "candidate-panel-missing-tabular-page-row-break")
require('isActiveRow || !expanded' in candidate_panel, "candidate-panel-missing-active-row-local-labels")
...
require('candidatePanelExpandedKeepsRowsHorizontal' in candidate_panel_self_check, "candidate-panel-self-check-missing-expanded-horizontal-row-case")
require('candidatePanelExpandedBreaksOnlyAtPageRows' in candidate_panel_self_check, "candidate-panel-self-check-missing-expanded-page-row-case")
...
require('candidatePanelExpandedDoesNotUseGlobalLabels' in candidate_panel_self_check, "candidate-panel-self-check-missing-no-global-label-case")
require('candidatePanelSecondPageUsesLocalLabels' in candidate_panel_self_check, "candidate-panel-self-check-missing-local-label-case")
