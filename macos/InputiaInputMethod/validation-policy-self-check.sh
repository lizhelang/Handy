...
require('maximumExpandedCandidateCount = 32' in candidate_panel, "candidate-panel-missing-expanded-thirty-two-candidate-cap")
require('expandedColumnCount = 8' in candidate_panel, "candidate-panel-missing-expanded-eight-column-grid")
require('expanded && index % expandedColumnCount == 0 ? "\\n" : "   "' in candidate_panel, "candidate-panel-missing-expanded-grid-line-break")
...
require('candidatePanelExpandedBreaksOnlyAtGridRows' in candidate_panel_self_check, "candidate-panel-self-check-missing-expanded-grid-row-case")
...
require('candidatePanelExpandedShowsThirtyTwoCandidates' in candidate_panel_self_check, "candidate-panel-self-check-missing-expanded-thirty-two-case")
require('candidatePanelExpandedCapsAtThirtyTwoCandidates' in candidate_panel_self_check, "candidate-panel-self-check-missing-expanded-cap-case")
