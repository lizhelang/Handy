...
VERIFY_NONGUI_MENU_CACHE_OWNED=0
if [[ -z "${INPUTIA_MENU_READINESS_CACHE_FILE:-}" ]]; then
  export INPUTIA_MENU_READINESS_CACHE_FILE="${TMPDIR:-/tmp}/inputia-menu-readiness.verify-nongui.$$.$RANDOM.cache"
  VERIFY_NONGUI_MENU_CACHE_OWNED=1
else
  export INPUTIA_MENU_READINESS_CACHE_FILE
fi
echo "verifyNonguiMenuReadinessCacheFile=$INPUTIA_MENU_READINESS_CACHE_FILE"
echo "verifyNonguiMenuReadinessCacheOwned=$VERIFY_NONGUI_MENU_CACHE_OWNED"
export INPUTIA_MENU_READINESS_ALLOW_AXPRESS="${INPUTIA_MENU_READINESS_ALLOW_AXPRESS:-0}"
export INPUTIA_GUI_SMOKE_READINESS_ALLOW_CHECK="${INPUTIA_GUI_SMOKE_READINESS_ALLOW_CHECK:-0}"
export INPUTIA_STATUS_INCLUDE_MENU_READINESS="${INPUTIA_STATUS_INCLUDE_MENU_READINESS:-0}"
export INPUTIA_STATUS_INCLUDE_GUI_SMOKE_READINESS="${INPUTIA_STATUS_INCLUDE_GUI_SMOKE_READINESS:-0}"
export INPUTIA_TIS_INCLUDE_MENU_READINESS="${INPUTIA_TIS_INCLUDE_MENU_READINESS:-0}"
echo "verifyNonguiMenuReadinessOptIn=$INPUTIA_MENU_READINESS_ALLOW_AXPRESS"
echo "verifyNonguiGuiReadinessOptIn=$INPUTIA_GUI_SMOKE_READINESS_ALLOW_CHECK"
echo "verifyNonguiStatusMenuReadinessOptIn=$INPUTIA_STATUS_INCLUDE_MENU_READINESS"
echo "verifyNonguiStatusGuiReadinessOptIn=$INPUTIA_STATUS_INCLUDE_GUI_SMOKE_READINESS"
echo "verifyNonguiTISMenuReadinessOptIn=$INPUTIA_TIS_INCLUDE_MENU_READINESS"
...
if [[ "$VERIFY_NONGUI_MENU_CACHE_OWNED" == "1" ]]; then
  VERIFY_TEMP_FILES+=("$INPUTIA_MENU_READINESS_CACHE_FILE")
fi
