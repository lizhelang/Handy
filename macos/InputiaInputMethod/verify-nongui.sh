...
export INPUTIA_MENU_READINESS_ALLOW_AXPRESS="${INPUTIA_MENU_READINESS_ALLOW_AXPRESS:-1}"
export INPUTIA_GUI_SMOKE_READINESS_ALLOW_CHECK="${INPUTIA_GUI_SMOKE_READINESS_ALLOW_CHECK:-1}"
